...
% On a les muscles Gauches de Lina

biceps=load('BicepsGaucheLina'); biceps=biceps.BicepsGaucheLina;
DroitAnterieur=load('DroitAnterieurGaucheLina'); DroitAnterieur=DroitAnterieur.DroitAnterieurGaucheLina;
gastrocnemien=load('GastrocnemienGaucheLina'); gastrocnemien=gastrocnemien.GastrocnemienGaucheLina;
gluteal=load('GlutealGaucheLina'); gluteal=gluteal.GlutealGaucheLina;
soleaire=load('SoleaireGaucheLina'); soleaire=soleaire.SoleaireGaucheLina;
tibialAnt=load('TibialAnterieurGaucheLina'); tibialAnt=tibialAnt.TAGaucheLina;
tendineux=load('TendineuxGaucheLina'); tendineux=tendineux.TendineuxGaucheLina; 
vaste=load('VasteGaucheLina'); vaste=vaste.VasteGaucheLina;
...
activationsGluteal{3,1}=activationsGluteal{3,1}(:,:,1:2);
%%
